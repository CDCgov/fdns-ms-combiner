...
ARG COMBINER_SEPARATOR_CSV
ARG COMBINER_SEPARATOR_VALUE
ARG OBJECT_URL
...
ENV COMBINER_SEPARATOR_CSV ${COMBINER_SEPARATOR_CSV}
ENV COMBINER_SEPARATOR_VALUE ${COMBINER_SEPARATOR_VALUE}
